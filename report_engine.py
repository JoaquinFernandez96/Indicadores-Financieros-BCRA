...
class PDFReport(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 10, f"Reporte de Benchmarking Financiero BCRA",
                  new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='L')

        self.set_font('helvetica', '', 10)
        self.cell(0, 5, f"Entidad: {self.cliente_nombre} | Período: {self.periodo}",
                  new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='L')
        self.ln(10)
    ...
    def footer(self):
        ...
        self.cell(0, 10, f'Generado el: {fecha_gen} | Confidencial · BCRA Dashboard', 0, align='L')
    ...
    def add_kpis(self, kpi_data):
        ...
        for i, kpi in enumerate(kpi_data):
            ...
            self.cell(width - 4, 5, kpi['label'], align='C',
                      new_x=XPos.LMARGIN, new_y=YPos.NEXT)

            self.set_x(x_start + (i * (width + 2)) + 2)
            self.set_text_color(30, 41, 59)
            self.set_font('helvetica', 'B', 12)
            self.cell(width - 4, 8, kpi['value'], align='C',
                      new_x=XPos.LMARGIN, new_y=YPos.NEXT)
            ...
            if kpi.get('delta'):
                ...
                self.cell(width - 4, 5, f"{kpi['delta']} vs Ref", align='C',
                          new_x=XPos.LMARGIN, new_y=YPos.NEXT)
